...
public class Hand {
     ...
     * 
     * @param c the card to be removed. If c is null or if the card is not in the
     *          hand, then nothing is done.
     */
     ...
     *                                  that is if the position is less than 0 or
     *                                  greater than or equal to the number of cards
     *                                  in the hand.
     */
    ...
    /**
     * Gets the card in a specified position in the hand. (Note that this card is
     * not removed from the hand!)
     * 
     ...
     * together. Cards with the same value are sorted by suit. Note that aces are
     * considered to have the lowest value, 1.
     */
