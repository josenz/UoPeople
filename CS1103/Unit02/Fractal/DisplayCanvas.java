...
public class DisplayCanvas extends JPanel {
    ...
    public void setPoints(Point[] var1) {
        ...
        for (int var4 = 1; var4 < var1.length; ++var4) {
            this.s[var4] = (double) ((this.x2 - this.x1) * (var1[var4].x - this.x1)
                    + (this.y2 - this.y1) * (var1[var4].y - this.y1)) / var2;
            this.t[var4] = (double) ((this.x2 - this.x1) * (var1[var4].y - this.y1)
                    - (this.y2 - this.y1) * (var1[var4].x - this.x1)) / var2;
        }
    ...
    protected void paintComponent(Graphics var1) {
        ...
        if (this.s != null) {
            ...
            this.drawLines(var1, this.recursionLevel, (double) this.x1, (double) this.y1, (double) this.x2,
                    (double) this.y2);
        }
