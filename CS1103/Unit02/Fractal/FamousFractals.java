...
public class FamousFractals extends JFrame implements ActionListener {
    ...
    private JMenuBar makeMenus() {
        ...
        menubar.add(menu);
        String[] itemList = new String[] { "Koch Curve", "Square Koch Curve", "Dragon Curve", "C-Curve",
                "Sierpinski Triangle", null, "Quit" };
    ...
    public void actionPerformed(ActionEvent evt) {
        ...
        if (cmd.equals("Quit"))
            ...
            int[] coords = { 50, 250, 50 + 400 / 3, 250, 50 + 400 / 3, 250 - 400 / 3, 50 + 800 / 3, 250 - 400 / 3,
                    50 + 800 / 3, 250, 450, 250 };
